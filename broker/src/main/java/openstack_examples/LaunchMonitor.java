...
public class LaunchMonitor {
	...
	public Server CreateServer() {
		...
		if (tenants.getList().size() > 0) {
			...
			// m1.tiny
			serverForCreate
					.setFlavorRef("href=http://openstack.infosys.tuwien.ac.at:8774/v2/3cc15bd5efe54b9daa5e59e4b3a0bb04/flavors/1");
			// Ubuntu
			serverForCreate
					.setImageRef("href=http://openstack.infosys.tuwien.ac.at:8774/v2/3cc15bd5efe54b9daa5e59e4b3a0bb04/images/4f62bc16-5fd0-48cc-bc4c-c438d48875bc");
	...
	public static void main(String[] args) {
		...
		Server server = monitor.CreateServer();
