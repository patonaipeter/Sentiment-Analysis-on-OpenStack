...
import tsa.classifier.Preprocesser;
...
public class DocumentsSet {
	 ...
	 * 
	 * @param d2fTrainStr
	 *            map for train that associates a tweet's id to a list of terms
	 */
	 ...
	 * 
	 * @param d2fTest
	 *            a map for test that associates a tweet's id to a list of
	 *            terms's id
	 */
	 ...
	 * 
	 * @param path_input
	 *            path of input file containing the initial tweets' dataset
	 * @param path_output
	 *            path of output file that will contain the tweets' dataset
	 *            after preprocessing
	 * @param opt
	 ...
	 * 
	 * @param path_input
	 *            path of file containing the preprocessed tweets' dataset
	 * @throws IOException
	 */
